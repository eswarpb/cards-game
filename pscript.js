...
const startTimer = () => {
  ...
  timerInterval = setInterval(() => {
    ...
    if (timer === 0) {
      ...
      document.getElementById("message").textContent = `⏳ Time's up! You ran out of time, ${playerName}! Try again!`;
  ...
  if (
    ...
    if (matches === cards.length) {
      ...
      document.getElementById(
        "message"
      ).textContent = `🎉👏🎊 Congratulations, ${playerName}! You matched all pairs in ${60-timer} seconds! and your score is ${score} 🎉👏🎊`;
